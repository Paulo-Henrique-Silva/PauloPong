...
namespace PauloPong.Library.Graphics
{
    public class Tilemap
    {
        ...
        /// <summary>
        /// Gets the width, in pixels, of a tile is drawn at.
        /// </summary>
        public float TileWidth => _tileset.TileWidth * Scale.X;

        /// <summary>
        /// Gets the height, in pixels, of a tile is drawn at.
        /// </summary>
        public float TileHeight => _tileset.TileHeight * Scale.Y;

        public Vector2 CenterPosition => new Vector2(Columns / 2 * TileWidth, Rows / 2 * TileHeight);
