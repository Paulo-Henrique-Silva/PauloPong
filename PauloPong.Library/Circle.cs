...
namespace PauloPong.Library
{
    public readonly struct Circle : IEquatable<Circle>
    {
        ...
        /// <summary>
        /// Returns the circle bounds of a sprite based in its position. 
        /// </summary>
        /// <param name="position">Position of the sprite in screen</param>
        /// <param name="sprite">Sprite used as reference</param>
        /// <returns></returns>
        public static Circle FromPositionAndSprite(Vector2 position, Sprite sprite) =>
            new Circle((int)(position.X + sprite.Width * 0.5f), (int)(position.Y + sprite.Height * 0.5f), (int)(sprite.Width * 0.5f));
    }
}
