//Code for Elements/DividerCopy (Container)
using GumRuntime;
using System.Linq;
using MonoGameGum;
...
partial class DividerCopy : MonoGameGum.Forms.Controls.FrameworkElement
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Elements/DividerCopy");
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new DividerCopy(visual);
            return visual;
        });
        global::MonoGameGum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(DividerCopy)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Elements/DividerCopy", () => 
        {
    ...
    public DividerCopy(InteractiveGue visual) : base(visual)
    {
    }
    public DividerCopy()
    {
